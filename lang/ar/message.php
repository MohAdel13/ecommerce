...
return [
    'unknown_error' => "فشل، يرجى المحاولة لاحقا",

    'wrong_credintials' => "البريد الالكتروني أو كلمة السر خطأ",
    'wrong_password' => "كلمة السر خطأ",
    'email_already_taken' => "هذا البريد الالكتروني مسجل من قبل",
